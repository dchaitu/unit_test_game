...
class _$AntImpl implements _Ant {
  ...
  @override
  String toString() {
    return 'Ant(antImagePath: $antImagePath, damage: $damage, currHealth: $currHealth, maxHealth: $maxHealth, lower: $lower, upper: $upper, food: $food, name: $name)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, antImagePath, damage, currHealth,
      maxHealth, lower, upper, food, name);
